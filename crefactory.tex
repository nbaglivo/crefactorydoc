...
\begin{itemize}
  \item Se vio una introducci\'on al proyecto y un vistazo general de como está organizado, explicando como funcionaba la misma hasta ese momento.
  \item Se vio como levantar el ambiente en la plataforma visualworks, y como cargar todos los archivos necesarios para el funcionamiento de la aplicaci\'on.
\end{itemize}
...
En esta reuni\'on quedamos en modificar el di\'alogo de carga de archivo para que permita explorar el file system. Debería ser similar al de carga de parcels.
