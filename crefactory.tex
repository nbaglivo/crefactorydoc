...
voy agregando chamuyo que se me ocurre para despues escribir algo con eso:
1) Highlight de sintaxis-
2) Sugerencia de refactoring.
3) Integrar tests en la interface para asegurar que el refactoring no rompio el codigo, esto podria ser mediante el uso de algun framework como puede ser CUnit.
4) Personalizacion de entorno: Colores...
5) Formateo de codigo
