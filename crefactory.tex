...
\begin{itemize}
  \item Se vio una introducci\'on al proyecto y un vistazo general de como está organizado.
...
\begin{itemize}
  \item Mejorar el di\'alogo de carga de un archivo. Que sea por ejemplo como el de carga de parcels.
  ...
  \item Manejar las excepciones para que cuando hay una conf. inv\'alida muestre en el código donde esta lo inv\'alido.
  \item Pensar en la posibilidad de hacer grafos de la inclusi\'on de archivos.
\end{itemize}

\subsection{Reuni\'on del lunes 17/09}
Quedamos en modificar el di\'alogo de carga de archivo para que permita explorar el file system. Debería ser similar al de carga de parcels.
...
\begin{itemize}
 ...
 \item Cuando se produce un error poder mostrar el archivo que lo produjo y hacer highlight en la línea de c\'odigo.
\end{itemize}
